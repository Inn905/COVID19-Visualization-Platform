...
$.fn.combo.defaults=$.extend({},$.fn.textbox.defaults,{inputEvents:{click:_ae2,input:_ae6,paste:_ae6,drop:_ae6,blur:_ae9},panelEvents:{mousedown:function(e){
e.preventDefault();
e.stopPropagation();
...
}).bind("keydown.tagbox",function(e){
_c38(_c34);
